...
const HOME_VAPI_FIRST_MESSAGE = 'Infinite Wealth Solutions AI - Nova speaking, how may I help you?';
      ...
      <div className="fixed bottom-5 right-5 z-[60]">
        ...
        >
          ...
          <div className="text-left">
            ...
            <div className="text-[11px] text-gray-300 leading-tight">Nova answers instantly</div>
          </div>
        </button>
      </div>
