...
export function HomePage() {
  ...
  const platforms = [
    ...
    {
      name: 'Threads', color: '#ffffff', bg: 'rgba(255,255,255,0.08)',
    ...
    {
      name: '19+ More', color: '#C8A24A', bg: 'rgba(200,162,74,0.10)',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {useCases.map((uc, i) => {
              ...
              return (
                <div key={i}
                  className="border rounded-xl p-6 flex flex-col gap-4 hover:border-white/10 transition-all"
                  style={{ background: 'rgba(22,22,24,0.92)', borderColor: 'rgba(255,255,255,0.06)' }}>
