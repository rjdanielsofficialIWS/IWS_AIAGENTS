...
interface Question {
  ...
  title: string;
  subtitle?: string;
  type: "textarea" | "multi-input" | "checkbox";
  placeholder?: string;
  rows?: number;
...
export function HomePage() {
  ...
  const questions: Question[] = [
    ...
    },
    {
      ...
      type: "textarea",
      placeholder:
        "What’s your business? What are you trying to accomplish? Any timeline or special requirements?",
      rows: 4,
    },
    {
      id: "contactInfo",
    ...
    <div className="min-h-screen text-white overflow-x-hidden bg-[#050608]">
      ...
      <header className="relative z-10 px-4 sm:px-6 lg:px-8 pt-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-lg sm:text-xl font-extrabold tracking-tight">Infinite Wealth Solutions</div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-5 text-lg text-gray-300 max-w-xl">
              Websites that convert. AI that answers calls. Automations that run the backend. Clean, modern, and built
              to scale.
            </p>
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-xl">
              {[
                ...
                <div key={i} className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-4">
            ...
            <div className="relative rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-7 overflow-hidden">
              ...
              <div className="mt-6 grid grid-cols-1 gap-3">
                {[
                  ...
                  return (
                    <div key={idx} className="rounded-2xl border border-white/10 bg-[#0B0D10]/60 p-4 flex items-start gap-3">
                      <div
      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-8 pb-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-gray-300 max-w-2xl mx-auto">Designed to look high-end and perform like a machine.</p>
          </div>
                    ...
                    {questions.map((_, idx) => (
                      <div
                        ...
                        className={`h-2.5 w-10 rounded-full transition-all ${
                          idx === currentStep ? "bg-[#FFD24A]" : idx < currentStep ? "bg-white/25" : "bg-white/10"
                        }`}
                      />
                    ))}
                  </div>
                      ...
                      <div key={q.id} className="w-full flex-shrink-0 px-1">
                        ...
                        {q.type === "checkbox" ? (
                            ...
                            {q.options?.map((opt) => (
                              ...
                              >
                                <input
                                  ...
                                  value={opt.value}
                                  checked={
                                    ((formData[q.id as keyof FormData] as string[])?.includes(opt.value) as boolean) ||
                                    false
                                  }
                          ...
                          <div className="space-y-5">
                            ...
                            {currentError && idx === currentStep && <p className="mt-1 text-sm text-red-300">{currentError}</p>}
                          </div>
                        )}
                      </div>
                    ))}
      ...
      <footer className="relative z-10 px-4 sm:px-6 lg:px-8 py-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-4">
          ...
          <div className="text-sm text-gray-400">© {new Date().getFullYear()} Infinite Wealth Solutions. All rights reserved.</div>
      ...
      {/* Vapi Voice Modal */}
      <VapiPhoneAgentModal isOpen={isVapiModalOpen} onClose={() => setIsVapiModalOpen(false)} />
    </div>
  );
}