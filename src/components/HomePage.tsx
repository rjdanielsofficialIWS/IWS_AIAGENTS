...
export function HomePage() {
  ...
  const platforms = [
    ...
    },
    {
      ...
      icon: <span className="text-lg font-black">19+</span>,
    },
  ];
          ...
          <div className="bg-gradient-to-br from-[#C8A24A]/8 to-gray-900/50 border border-[#C8A24A]/20 rounded-2xl p-8 sm:p-12">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-4 gap-3">
                {platforms.map(p => (
                  <div key={p.name}
                    className="aspect-square rounded-xl border flex flex-col items-center justify-center gap-1.5 p-2 transition-all hover:scale-105 cursor-default"
